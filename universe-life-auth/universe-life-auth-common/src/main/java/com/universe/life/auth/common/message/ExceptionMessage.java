package com.universe.life.auth.common.message;
...
public interface ExceptionMessage {
    ...
    class Formatter {
         ...
         * @return 错误消息
         */
        public static String dataAlreadyExist(String dataName) {
            return format(RECORD_ALREADY_EXISTS, dataName);
        }
        ...
        public static String dataNotFound(String dataName) {
            return format(RECORD_NOT_FOUND, dataName);
        }
    }
