...
(
    ...
    `status`            TINYINT         NOT NULL DEFAULT 0 COMMENT '状态：0待审核 1审核拒绝 2招募中 3待支付 4支付中 5支付失败 6进行中 7已完成 8已取消 9已下架 10待退款 11退款中 12退款失败',
    ...
    key `idx_sts_pub` (status, publisher_id, deleted) ,
